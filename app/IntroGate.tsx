...
export default function IntroGate() {
  ...
  return <section className={`intro-gate ${leaving?"is-leaving":""}`} aria-label="Ingresso NAC Amatori Castellana"><canvas ref={canvasRef} className="intro-canvas" aria-hidden="true"/><div className="intro-glow" aria-hidden="true"/><div className="intro-content"><span className="intro-kicker">CASTEL GOFFREDO · DAL 2014</span><img src="/nac-scudetto.png" alt="NAC Amatori Castellana" className="intro-crest"/><h1>N.A.C.</h1><p>PASSIONE · UNITÀ · RISPETTO</p><button type="button" onClick={enter} className="intro-enter"><span>ENTRA NELLA SQUADRA</span><b>→</b></button></div><span className="intro-hint">Muovi il cursore · Clicca per accendere la rete</span></section>;
}
