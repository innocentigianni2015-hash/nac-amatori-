...
export default function Home(){
  ...
  return <main>
    ...
    <section className="editorialEvents" aria-labelledby="agenda-title"><div className="section"><small>05 — PROSSIMI APPUNTAMENTI</small><h2 id="agenda-title">La stagione<br/><em>comincia adesso.</em></h2><div className="eventGrid"><article className="eventPoster"><img src={settings.media_home_preparazione?(settings.media_home_preparazione.startsWith("/")?settings.media_home_preparazione:`/api/media/${settings.media_home_preparazione.split("/").map(encodeURIComponent).join("/")}`):"/preparazione-nac.jpeg"} alt="Programma preparazione NAC stagione 2026-2027"/><div className="eventCopy"><small>29 AGO — 19 SET</small><h3>Preparazione 2026/27</h3><p>Allenamenti, amichevoli e prima giornata di campionato.</p></div></article><article className="eventPoster"><img src={settings.media_home_memorial?(settings.media_home_memorial.startsWith("/")?settings.media_home_memorial:`/api/media/${settings.media_home_memorial.split("/").map(encodeURIComponent).join("/")}`):"/memorial-ferri.jpeg"} alt="Locandina del Memorial Marco e Stefano Ferri"/><div className="eventCopy"><small>08 — 12 SET · BARCHI DI ASOLA</small><h3>Memorial Ferri</h3><p>Quadrangolare di calcio a 11.</p></div></article></div></div></section>
