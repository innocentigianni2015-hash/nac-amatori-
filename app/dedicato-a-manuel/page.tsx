  ...
  return (
    <main className="memorial-page">
      ...
      <section className="memorial-photo-block">
        ...
        <img
          src={st.media_manuel_team?(st.media_manuel_team.startsWith("/")?st.media_manuel_team:`/api/media/${st.media_manuel_team.split("/").map(encodeURIComponent).join("/")}`):"/manuel-calandrino-team.jpg"}
