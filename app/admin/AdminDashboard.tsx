...
export default function AdminDashboard({initialData,userName,signOutPath}:{initialData:Snapshot;userName:string;signOutPath:string}) {
  ...
  const upload=async(entity:"player"|"staff"|"sponsor",id:string,file:File)=>{
...
function ContentEditor({settings,sponsors,busy,onSave,onSponsor,onUpload}:{settings:Record<string,string>;sponsors:Sponsor[];busy:boolean;onSave:(s:Record<string,string>)=>void;onSponsor:(a:string,p:Record<string,unknown>)=>void;onUpload:(e:"player"|"staff"|"sponsor",id:string,f:File)=>void}){
